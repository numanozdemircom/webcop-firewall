...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Attacker Blocking</h3>
		...
		You can enter the IP address you want to block.
You can learn visitor\'s IP address from attacker detecting page or control panel of your server or third party softwares.<br><br>
<center><form action="" method="post">';
if($_POST['ipadresi'] and $_POST['csrftoken'] == $_SESSION['csrftoken']){
$ipengelle = injblock($_POST['ipadresi']);
$ipvarmi = $dbbaglan->query("SELECT COUNT(*) FROM ipban WHERE ip = '".$ipengelle."'");
...
echo '
<input name="ipadresi" type="text" class="form-control" style="width: 20%" placeholder="IP Address">
		<input type="submit" style="width: 20%" class="btn bg-purple btn-flat margin" value="Block IP Address"></form></center>
...
';
echo '<input type="hidden" name="ipburada" value="'.$ipcek.'"><input type="hidden" name="csrftoken2" value="'.$_SESSION['csrftoken2'].'"><input type="submit" style="width: 20%" value="Remove" name="bankaldir" class="btn bg-purple btn-flat margin"></form></td>
</tr>';
}
}
