...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Mirror - Zone Protection</h3>
		...
		<form action="" method="post">This feature blocks to mirroring your website by popular mirror-zone services.
		<br>
<center><br>
...
if($guvtbl['mirrorkorumasi'] == 0){
		echo '<font color="green"><b>ACTIVATE</b></font> the mirror-zone protection.</label>';
	...
	echo '<font color="red"><b>DEACTIVATE</b></font> the mirror-zone protection.</label>';
	if($_POST['mirror-zone'] and $_POST['csrftoken'] == $_SESSION['csrftoken']){
