...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Attacker Detecting / Attacking Attempts</h3>
		...
		If you activate this feature, firewall blocks attacker\'s IP address automatically. The firewall can auto detect and block some URL-based hacking attempts like XSS, SQL injection, code injection etc.<br>
		<b><font color="red">EXAMPLE:</font></b> '.strip_tags($_SERVER['SERVER_NAME']).'/content?p=PAYLOAD 
		<br>
		<font color="red"><b>NOTE:</b></font> This feature may cause blocking some search engines.
		<br><br>
...
if($guvtbl['saldirgantespit'] == 0){
		echo '<font color="green"><b>ACTIVATE</b></font> detecting attempts of attack</label>';
	...
	echo '<font color="red"><b>DEACTIVATE</b></font> detecting attempts of attack</label>';
	if($_POST['saldiritespiti'] and $_POST['csrftoken'] == $_SESSION['csrftoken']){
