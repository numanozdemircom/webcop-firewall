...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">URL Redirecting</h3>
		...
		<form action="" method="post">You can redirect your website to another URL. Enter below the URL that you will redirect.<br><br>
...
if($guvtbl['urlyonlendir'] == 0){
		echo '<font color="green"><b>ACTIVATE</b></font> the URL redirecting.</label>';
...
if(filter_var($_POST['urlgir'], FILTER_VALIDATE_URL)){
		...
		echo "<br><font color='red'><b>Enter a valid URL.</b></font>";
		}
	}else{
	...
	echo '<font color="red"><b>DEACTIVATE</b></font> the URL redirecting.</label>';
	if($_POST['urlyon'] and $_POST['csrftoken'] == $_SESSION['csrftoken']){
if(filter_var($_POST['urlgir'], FILTER_VALIDATE_URL)){
		$engellenecekler = array("'", '"', "\\", ";", ">", "<", "data:", "javascript:");
		$urlguncelle = str_replace($engellenecekler, "", strtolower($_POST['urlgir']));
