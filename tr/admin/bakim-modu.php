      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
			...
			<div style="margin-left: 10px; margin-top: 10px;">Sitenizi bakım moduna aldığınızda sitenizde görünmesini istediğiniz ekranı aşağıdan tasarlayabilirsiniz.</div>
            <!-- /.box-header -->
...
if($guvtbl['bakimmodu'] == 0){
	...
	echo '<script>window.location.assign(document.URL);</script>';
		...
		echo '<input name="guncelle" type="submit" style="width: 20%" class="btn bg-purple btn-flat margin" value="Tasarımı Kaydet ve Bakım Modunu Aç"></form>';
}else{
    if($_POST['guncelle'] and $_POST['csrftoken'] == $_SESSION['csrftoken']){
	if(!stristr($_POST['editor1'], $textareaengel)){
	...
	echo '<input name="guncelle" type="submit" style="width: 21%" class="btn bg-purple btn-flat margin" value="Tasarımı Kaydet ve Bakım Modunu Kapat"></form>';
}
}
}
			echo '
