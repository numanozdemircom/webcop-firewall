...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Saldırgan İzleme / Flood Saldırıları</h3>
		...
		Bu özelliği aktif ederseniz flood saldırısı yapan IP adreslerini aşağıda görebilirsiniz. 15 saniye içerisinde 20 ve üzeri istek gönderen IP adreslerini listeler, sunucudan otomatik banlar.<br>
...
<div class="custom-control custom-checkbox">
      ...
      <label class="custom-control-label" for="customCheck1">Flood korumasını ';
...
echo '
<td>'.$ipcek.'</td>
<td><input type="hidden" name="ipburada" value="'.$ipcek.'">
<input type="hidden" name="csrftoken2" value="'.$_SESSION['csrftoken2'].'">
<input type="submit" style="width: 20%" value="Kaldır" name="bankaldir" class="btn bg-purple btn-flat margin"></form>
</td>
</tr>';
			}
}
