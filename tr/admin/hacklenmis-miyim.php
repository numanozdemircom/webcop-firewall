...
<div class="wrapper">
  ...
  <div style="width: 70%" class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Hack\'lenmiş Miyim?</h3>
		...
		Sistemde kayıtlı olan e-mail adresinize bağlı ('.$ayartbl['adminemail'].') herhangi bir hesabınız hack\'lendiyse, aşağıda görebilirsiniz. 300 üzeri kaynaktan anlık olarak tarama yapar. İşte sonuç:<br><br>
<pre>';
...
if(@count($cek) > 0){
	echo "Üyesi olduğunuz bu adresler daha önceden hack'lenmiş ve üyelik bilgileriniz internete sızdırılmıştır.";
	for($i=0; $i<@count($cek); $i++){
		echo "<li>".$cek[$i]['Domain']."</li>";
	}
	echo 'Şifrelerinizi güncellemeyi unutmayın!';
}else{
	echo "Görüşünüşe göre e-mail adresinize bağlı herhangi bir hesabınız hack'lenmemiş.";
}
