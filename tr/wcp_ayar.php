...
die('<script>document.write(\'<title>Erişim Engellendi</title><center><font color="red" face="Courier New"><b><h3>Erişim Engellendi<br></h3><font color="green">WebCOP Firewall Tarafından Korunmaktadır\');</script>');
}
}
}
...
die('<script>document.write(\'<title>Bu İnternet Sitesi Korunmaktadır</title><center><font color="red" face="Courier New"><b><h3>Erişim Engellendi<br></h3><font color="green">WebCOP Firewall Tarafından Korunmaktadır\');</script>');
}
}
...
if($_SESSION['ilk'] < time() - 15){
    $_SESSION['tekrar'] = 1; // 15 saniyede bir toplam saymayı temizler.
}
...
die('<script>document.write(\'<title>Saldırı Tespit Edildi</title><center><font color="red" face="Courier New"><b><h3>Saldırı Tespit Edildi - Erişim Engellendi<br></h3><font color="green">WebCOP Firewall Tarafından Korunmaktadır\');</script>');
}
}
// 15 saniyede 20 istek gelirse banla.
}
}
}
